...
final class RecordNormalizerTest extends TestCase
{
    ...
    /**
     * Test that normalization ALWAYS includes null values (uniform behavior).
     * This is the new consistent behavior across all normalizers.
     */
    public function test_normalize_includes_null_values(): void
    {
        ...
        // Les null sont TOUJOURS inclus - comportement uniforme
        $this->assertArrayHasKey('id', $normalized);
        $this->assertArrayHasKey('email_verified_at', $normalized);
